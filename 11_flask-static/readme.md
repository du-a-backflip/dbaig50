...
NOTES:
* with app.route("/"), it just leads you to a site that says "No hablo queso" (as expected)
* with app.route("static/foo.html"), it leads you to a site that has a random decimal number.
* changing the file of foo.html doesn't change what is shown on the website mentioned in the file. But if you add another slash to the URL, it renders the html file?
<br>
